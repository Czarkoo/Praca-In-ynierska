...
import podciaganie_nachwytem from '../../assets/podciaganie_nachwytem.webp';
...
const ExerciseList = ({ click }) => {
	...
	const filteredExercises = click
		? exercises.filter((exercise) => exercise.section === click)
		: exercises;
